...
export default function FallingBeams() {
  ...
  return (
    <div ref={parentRef} className="absolute inset-0 pointer-events-none overflow-hidden">
      {beams.map((beam) => (
        <CollisionMechanism key={beam.initialX} beamOptions={beam} containerRef={containerRef} parentRef={parentRef} />
      ))}
      {/* Target tabrakan di bagian bawah layar */}
